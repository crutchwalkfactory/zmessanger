...
{
 x_status_map[0]=LNG_XSTATUS_NO;
 x_status_map[1]=LNG_XSTATUS_ANGRY;
 x_status_map[2]=LNG_XSTATUS_BATH;
 x_status_map[3]=LNG_XSTATUS_TIRED;
 x_status_map[4]=LNG_XSTATUS_PARTY;
 x_status_map[5]=LNG_XSTATUS_BEER;
 x_status_map[6]=LNG_XSTATUS_THINK;
 x_status_map[7]=LNG_XSTATUS_EAT;
 x_status_map[8]=LNG_XSTATUS_TV;
 x_status_map[9]=LNG_XSTATUS_MEET;
 x_status_map[10]=LNG_XSTATUS_COFFEE;
 x_status_map[11]=LNG_XSTATUS_MUSIC;
 x_status_map[12]=LNG_XSTATUS_BUSINESS;
 x_status_map[13]=LNG_XSTATUS_SHOOT;
 x_status_map[14]=LNG_XSTATUS_FUN;
 x_status_map[15]=LNG_XSTATUS_PHONE;
 x_status_map[16]=LNG_XSTATUS_GAME;
 x_status_map[17]=LNG_XSTATUS_STUDY;
 x_status_map[18]=LNG_XSTATUS_SHOP;
 x_status_map[19]=LNG_XSTATUS_SICK;
 x_status_map[20]=LNG_XSTATUS_SLEEP;
 x_status_map[21]=LNG_XSTATUS_SURFING;
 x_status_map[22]=LNG_XSTATUS_BROWSE;
 x_status_map[23]=LNG_XSTATUS_WORK;
 x_status_map[24]=LNG_XSTATUS_TYPE;
 x_status_map[25]=LNG_XSTATUS_PICNIC;
 x_status_map[26]=LNG_XSTATUS_COOK;
 x_status_map[27]=LNG_XSTATUS_SMOKE;
 x_status_map[28]=LNG_XSTATUS_IM_HIGH;
 x_status_map[29]=LNG_XSTATUS_WC;
 x_status_map[30]=LNG_XSTATUS_BE_NOT_BE;
 x_status_map[31]=LNG_XSTATUS_PRO7_TV;
 x_status_map[32]=LNG_XSTATUS_LOVE;
 x_status_map[33]=LNG_XSTATUS_SMOKING;
 x_status_map[34]=LNG_XSTATUS_SEX;
 x_status_map[35]=LNG_XSTATUS_SEARCHING;
 x_status_map[36]=LNG_XSTATUS_JOURNAL;
 x_status_map[37]=LNG_XSTATUS_LOVE2;

 
 country_map[0]="";
 country_map[9999]="Другое";
...
void init_strings_maps(void)
{
 ...
 x_status_map[33]="Smoking";
 x_status_map[34]="Sex";
 x_status_map[35]="Searching";
 x_status_map[36]="Journal";
 x_status_map[37]="Love";
