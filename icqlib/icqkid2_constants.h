...
#define X_STATUS_SEARCH    (size_t)33
#define X_STATUS_TYPE2     (size_t)34
#define X_STATUS_LOVE2     (size_t)35
#define X_STATUS_SMOKING   (size_t)36
#define X_STATUS_SEX       (size_t)37


#define X_STATUS_MAX_BOUND X_STATUS_LOVE2
...
static const struct
{
	...
	size_t len;
	uint8_t data[16];
} icq_clients[ICQ_CLIENTS_COUNT] =
{
	{"Unknown","unknown", 0,
		{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"QIP Infium","qip_infium", 16,
	 {0x7C, 0x73, 0x75, 0x02, 0xC3, 0xBE, 0x4F, 0x3E,
	  0xA6, 0x9F, 0x01, 0x53, 0x13, 0x43, 0x1E, 0x1A}},
	{"QIP 2005","qip_2005", 16,
	 {0x56, 0x3F, 0xC8, 0x09, 0x0B, 0x6F, 0x41, 'Q',
	  'I', 'P', ' ', '2', '0', '0', '5', 'a'}},
	{"Miranda","miranda", 8,
	 {0x4D, 0x69, 0x72, 0x61, 0x6E, 0x64, 0x61, 0x4D,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"qutIM","qutim", 5,
	 {0x71, 0x75, 0x74, 0x69, 0x6D, 0x00, 0x00, 0x00,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"QIP PDA (Symbian)","qip_pda_sym", 16, //51ADD1907204473DA1A149F4A397A41F
	 {0x51, 0xAD, 0xD1, 0x90, 0x72, 0x04, 0x47, 0x3D,
	  0xA1, 0xA1, 0x49, 0xF4, 0xA3, 0x97, 0xA4, 0x1F}},
	{"QIP PDA (Windows)","qip_pda_win", 16, //563FC8090B6F41514950202020202021
	 {0x56, 0x3F, 0xC8, 0x09, 0x0B, 0x6F, 0x41, 0x51,
	  0x49, 0x50, 0x20, 0x20, 0x20, 0x20, 0x20, 0x21}},
	{"Jimm LocID","locid", 11, //4C6F634944200000000000
	 {0x4C, 0x6F, 0x63, 0x49, 0x44, 0x20, 0x00, 0x00,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"D[i]Chat","di_chat", 9, //445B695D4368617420
	 {0x44, 0x5B, 0x69, 0x5D, 0x43, 0x68, 0x61, 0x74,
	  0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"wJimm","wjimm", 5, //774A696D6D
	 {0x77, 0x4A, 0x69, 0x6D, 0x6D, 0x20, 0x00, 0x00,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"Jimm CORE Pager","corepager", 16, //43 4F 52 45 20 50 61 67 65 72 000000000000
	 {0x43, 0x4F, 0x52, 0x45, 0x20, 0x50, 0x61, 0x67,
	  0x65, 0x72, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"Jimm","jimm", 4,
	 {0x4A, 0x69, 0x6D, 0x6D, 0x00, 0x00, 0x00, 0x00,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"Miranda Aim","miranda_aim", 8,
	 {0x4D, 0x69, 0x72, 0x61, 0x6E, 0x64, 0x61, 0x41,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"zMessanger","zmessanger", 4,
	 {'z', 'I', 'M', ' ', 0x00, 0x00, 0x00, 0x00,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"bayanICQ","bayanicq", 8, //626179616E494351
	 {0x62, 0x61, 0x79, 0x61, 0x6E, 0x49, 0x43, 0x51,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"Smaper","smaper", 8, //536D617065722076
	 {0x53, 0x6D, 0x61, 0x70, 0x65, 0x72, 0x20, 0x76,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"Miranda","miranda", 4,//4D494D2F
	 {0x4D, 0x49, 0x4D, 0x2F, 0x00, 0x00, 0x00, 0x00,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"MacICQ","icq_mac", 16, //DD16F20284E611D490DB00104B9B4B7D
	 {0xDD, 0x16, 0xF2, 0x02, 0x84, 0xE6, 0x11, 0xD4,
	  0x90, 0xDB, 0x00, 0x10, 0x4B, 0x9B, 0x4B, 0x7D}},
	{"R&Q","rnq", 16, //D6687F4F3DC34BDB8A8C4C1A572763CD
	 {0xD6, 0x68, 0x7F, 0x4F, 0x3D, 0xC3, 0x4B, 0xDB,
	  0x8A, 0x8C, 0x4C, 0x1A, 0x57, 0x27, 0x63, 0xCD}},
	{"Rambler ICQ","icq_rambler", 16,
	 {0x7E, 0x11, 0xB7, 0x78, 0xA3, 0x53, 0x49, 0x26,
	  0xA8, 0x02, 0x44, 0x73, 0x52, 0x08, 0xC4, 0x2A}},
	{"ICQ 2001","icq_2001", 16,
	 {0x2e, 0x7a, 0x64, 0x75, 0xfa, 0xdf, 0x4d, 0xc8,
	  0x88, 0x6f, 0xea, 0x35, 0x95, 0xfd, 0xb6, 0xdf}},
	{"ICQ 2002","icq_2002", 16,
	 {0x10, 0xcf, 0x40, 0xd1, 0x4c, 0x7f, 0x11, 0xd1,
	  0x82, 0x22, 0x44, 0x45, 0x53, 0x54, 0x00, 0x00}},
	{"Kopete","kopete", 12,
	 {'K', 'o', 'p', 'e', 't', 'e', ' ', 'I',
	  'C', 'Q', ' ', ' ', 0x00, 0x00, 0x00, 0x00}},
	{"iChat","ichat", 5, //45535400000946
	 {0x45, 0x53, 0x54, 0x00, 0x00, 0x09, 0x46, 0x00,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"mChat","mchat", 9, //6D4368617420696371
	 {0x6D, 0x43, 0x68, 0x61, 0x74, 0x20, 0x69, 0x63,
	  0x71, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"&RQ","rq", 9, //26 52 51 69 6E 73 69 64 65
	 {0x26, 0x52, 0x51, 0x69, 0x6E, 0x73, 0x69, 0x64,
	  0x65, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"PIGEON!","pigeon", 7, //5049 47 45 4F 4E 21
	 {0x50, 0x49, 0x47, 0x45, 0x4F, 0x4E, 0x21, 0x00,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"Jabber ICQ Transport","jit", 3, //4A4954
	 {0x4A, 0x49, 0x54, 0x00, 0x00, 0x00, 0x00, 0x00,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"VmICQ","vmicq", 6, //56 6D 49 43 51 20
	 {0x56, 0x6D, 0x49, 0x43, 0x51, 0x20, 0x00, 0x00,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"Yapp!","yapp", 4, //59 61 70 70
	 {0x59, 0x61, 0x70, 0x70, 0x00, 0x00, 0x00, 0x00,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"NatICQ","naticq", 6, //4E 61 74 49 43 51
	 {0x4E, 0x61, 0x74, 0x49, 0x43, 0x51, 0x00, 0x00,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"SIM","sim", 12, //53494D20636C69656E742020
	 {0x53, 0x49, 0x4D, 0x20, 0x63, 0x6C, 0x69, 0x65,
	  0x6E, 0x74, 0x20, 0x20, 0x00, 0x00, 0x00, 0x00}},
	{"TICQClient","ticqclient", 16, //A0E93F374C7F11D18222444553540000
	 {0xA0, 0xE9, 0x3F, 0x37, 0x4C, 0x7F, 0x11, 0xD1,
	  0x82, 0x22, 0x44, 0x45, 0x53, 0x54, 0x00, 0x00}},
	{"Mail.Ru Agent (Java)","mra_mobile", 16, //4A324D45206D406167656E7400030504
	 {0x4A, 0x32, 0x4D, 0x45, 0x20, 0x6D, 0x40, 0x61,
	  0x67, 0x65, 0x6E, 0x74, 0x00, 0x03, 0x05, 0x04}},
	{"Mail.Ru Agent (WM)","mra_mobile", 7, //4167656E74574D
	 {0x41, 0x67, 0x65, 0x6E, 0x74, 0x57, 0x4D, 0x00,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{"PHPCor","phpcore", 8, //504850436F726520
	 {0x50, 0x48, 0x50, 0x43, 0x6F, 0x72, 0x65, 0x20,
	  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},

	{"ICQ 6","icq_6x", 16, //capHtmlMsgs013
	 {0x01, 0x38, 0xca, 0x7b, 0x76, 0x9a, 0x49, 0x15,
	  0x88, 0xf2, 0x13, 0xfc, 0x00, 0x97, 0x9e, 0xa8}},
	//????????

	{"AIM 7","aim", 16, //0946010D4C7F11D18222444553540000
	 {0x09, 0x46, 0x01, 0x0D, 0x4C, 0x7F, 0x11, 0xD1,
	  0x82, 0x22, 0x44, 0x45, 0x53, 0x54, 0x00, 0x00}},

	{"ICQ Lite","icq_lite", 16, //094601074C7F11D18222444553540000
	 {0x09, 0x46, 0x01, 0x07, 0x4C, 0x7F, 0x11, 0xD1,
	  0x82, 0x22, 0x44, 0x45, 0x53, 0x54, 0x00, 0x00}},

	{"Talkonaut","talk", 16, //0946134B4C7F11D18222444553540000
	 {0x09, 0x46, 0x13, 0x4B, 0x4C, 0x7F, 0x11, 0xD1,
	  0x82, 0x22, 0x44, 0x45, 0x53, 0x54, 0x00, 0x00}},

	{"Pidgin/Adium","pidgin", 16, //748F2420628711D18222444553540000
	 {0x74, 0x8F, 0x24, 0x20, 0x62, 0x87, 0x11, 0xD1,
	  0x82, 0x22, 0x44, 0x45, 0x53, 0x54, 0x00, 0x00}},
	{"ICQ 5","icq_50", 16, //67361515612D4C078F3DBDE6408EA041
	 {0x67, 0x36, 0x15, 0x15, 0x61, 0x2D, 0x4C, 0x07,
	  0x8F, 0x3D, 0xBD, 0xE6, 0x40, 0x8E, 0xA0, 0x41}},
	{"ICQ 5.1","icq_51", 16, //B2EC8F167C6F451BBD79DC58497888B9
	 {0xB2, 0xEC, 0x8F, 0x16, 0x7C, 0x6F, 0x45, 0x1B,
	  0xBD, 0x79, 0xDC, 0x58, 0x49, 0x78, 0x88, 0xB9}},
	{"PyICQt","pyicqt", 16, //178C2D9BDAA545BB8DDBF3BDBD53A10A
	 {0x17, 0x8C, 0x2D, 0x9B, 0xDA, 0xA5, 0x45, 0xBB,
	  0x8D, 0xDB, 0xF3, 0xBD, 0xBD, 0x53, 0xA1, 0x0A}},
	{"PyICQt","pyicqt", 16, //1a093c6cd7fd4ec59d51a6474e34f5a0
