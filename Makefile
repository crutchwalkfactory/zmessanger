...
DIRECTIV =	-DEZX_ZN5 -DNEW_PLATFORM -DCUTED_PLATFORM -DFixByQT
TARGET	=      $(APPNAME)_ZN5
endif
...
DIRECTIV =	-DEZX_E8 -DSCREEN_GORIZONTAL -DNEW_PLATFORM -DFixByQT -D_FixQVBoxLayout
TARGET	=      $(APPNAME)_E8
endif
...
DIRECTIV =	-DEZX_EM30 -DSCREEN_GORIZONTAL -DNEW_PLATFORM -DFixByQT -D_FixQVBoxLayout
...
DIRECTIV =	-DEZX_EM35 -DNEW_PLATFORM -DFixByQT -D_FixQVBoxLayout
...
DIRECTIV =	-DEZX_VE66 -DNEW_PLATFORM -DFixByQT -D_FixQVBoxLayout
